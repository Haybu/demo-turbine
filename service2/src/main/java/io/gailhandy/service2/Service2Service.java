...
public class Service2Service {
	...
	Logger logger = LoggerFactory.getLogger(Service2Service.class);

	@HystrixCommand(fallbackMethod = "service2AnotherValue")
	public String service2Value() {
	...
	public String service2AnotherValue() {
